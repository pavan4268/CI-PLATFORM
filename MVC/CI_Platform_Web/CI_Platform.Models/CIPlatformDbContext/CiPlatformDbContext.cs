...
namespace CI_Platform.Entities.CIPlatformDbContext;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<City>(entity =>
        {
            ...
            entity.HasOne(d => d.Country).WithMany(p => p.Cities)
                ...
                .HasConstraintName("city_countryID_fk");
        });
        ...
        modelBuilder.Entity<Comment>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Comments)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("comment_missionID_fk");
        ...
        modelBuilder.Entity<FavoriteMission>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("favoritemission_missionID_fk");

            entity.HasOne(d => d.User).WithMany(p => p.FavoriteMissions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("favoritemission_userID_fk");
        });
        ...
        modelBuilder.Entity<GoalMission>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.GoalMissions)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("goalmission_missionID_fk");
        });
        ...
        modelBuilder.Entity<Mission>(entity =>
        {
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Missions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("mission_cityID_fk");

            entity.HasOne(d => d.Country).WithMany(p => p.Missions)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("mission_countryID_fk");

            entity.HasOne(d => d.Theme).WithMany(p => p.Missions)
                .HasForeignKey(d => d.ThemeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("mission_themeID_fk");
        });
        ...
        modelBuilder.Entity<MissionApplication>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionApplication_missionID_fk");

            entity.HasOne(d => d.User).WithMany(p => p.MissionApplications)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionApplication_userID_fk");
        });
        ...
        modelBuilder.Entity<MissionDocument>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionDocuments)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionDocument_missionID_fk");
        });
        ...
        modelBuilder.Entity<MissionInvite>(entity =>
        {
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.MissionInviteFromUsers)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionInvite_from_user_id_fk");

            entity.HasOne(d => d.Mission).WithMany(p => p.MissionInvites)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionInvite_missionID_fk");

            entity.HasOne(d => d.ToUser).WithMany(p => p.MissionInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionInvite_to_user_id_fk");
        });
        ...
        modelBuilder.Entity<MissionMedium>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionMedia)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionMedia_missionID_fk");
        });
        ...
        modelBuilder.Entity<MissionRating>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionRating_missionID_fk");

            entity.HasOne(d => d.User).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionRating_userID_fk");
        });
        ...
        modelBuilder.Entity<MissionSkill>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionSkill_missionID_fk");

            entity.HasOne(d => d.Skill).WithMany(p => p.MissionSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("missionSkill_skillID_fk");
        });
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.Property(e => e.Message)
                .HasColumnType("text")
                .HasColumnName("message");
            entity.Property(e => e.NotifTypeId).HasColumnName("notif_type_id");
            entity.Property(e => e.Status)
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.NotificationFromUsers)
                .HasForeignKey(d => d.FromUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__notificat__from___318258D2");

            entity.HasOne(d => d.NotifType).WithMany(p => p.Notifications)
                .HasForeignKey(d => d.NotifTypeId)
                .HasConstraintName("FK__notificat__notif__336AA144");

            entity.HasOne(d => d.ToUser).WithMany(p => p.NotificationToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__notificat__to_us__32767D0B");
        });

        modelBuilder.Entity<NotificationType>(entity =>
        {
            entity.HasKey(e => e.NotificationTypeId).HasName("PK__notifica__0BD11F11077E4D5D");
            ...
            entity.Property(e => e.DeletedAt)
                .HasColumnType("datetime")
                .HasColumnName("deleted_at");
            entity.Property(e => e.SettingsTitle).HasColumnName("settings_title");
            entity.Property(e => e.Status)
                .HasDefaultValueSql("((1))")
                .HasColumnName("status");
            entity.Property(e => e.UpdatedAt)
        ...
        modelBuilder.Entity<Story>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Stories)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("story_MissionId_fk");

            entity.HasOne(d => d.User).WithMany(p => p.Stories)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("story_UserId_fk");
        });
        ...
        modelBuilder.Entity<StoryInvite>(entity =>
        {
            ...
            entity.HasOne(d => d.FromUser).WithMany(p => p.StoryInviteFromUsers)
                .HasForeignKey(d => d.FromUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("storyInvite_fromUserID_fk");

            entity.HasOne(d => d.Story).WithMany(p => p.StoryInvites)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("storyInvite_storyID_fk");

            entity.HasOne(d => d.ToUser).WithMany(p => p.StoryInviteToUsers)
                .HasForeignKey(d => d.ToUserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("storyInvite_toUserID_fk");
        });
        ...
        modelBuilder.Entity<StoryMedium>(entity =>
        {
            ...
            entity.HasOne(d => d.Story).WithMany(p => p.StoryMedia)
                .HasForeignKey(d => d.StoryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("storyMission_storyID_fk");
        });
        ...
        modelBuilder.Entity<Timesheet>(entity =>
        {
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.MissionId)
                .HasConstraintName("timesheet_MissionId_fk");

            entity.HasOne(d => d.User).WithMany(p => p.Timesheets)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("timesheet_UserId_fk");
        });
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.HasOne(d => d.City).WithMany(p => p.Users)
                .HasForeignKey(d => d.CityId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("user_cityID_fk");

            entity.HasOne(d => d.Country).WithMany(p => p.Users)
                .HasForeignKey(d => d.CountryId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("user_countryID_fk");
        });

        modelBuilder.Entity<UserSetting>(entity =>
        {
            entity.HasKey(e => e.UserSettingsId).HasName("PK__user_set__842A74B0B539617E");

            entity.ToTable("user_settings");

            entity.Property(e => e.UserSettingsId).HasColumnName("user_settings_id");
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("(getdate())")
                .HasColumnType("datetime")
                .HasColumnName("created_at");
            entity.Property(e => e.DeletedAt)
                ...
                .IsFixedLength()
                .HasColumnName("deleted_at");
            entity.Property(e => e.NotifSettingId).HasColumnName("notif_setting_id");
            entity.Property(e => e.Status)
                .HasDefaultValueSql("((1))")
                .HasColumnName("status");
            entity.Property(e => e.UpdatedAt)
            ...
            entity.HasOne(d => d.NotifSetting).WithMany(p => p.UserSettings)
                .HasForeignKey(d => d.NotifSettingId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_sett__notif__39237A9A");

            entity.HasOne(d => d.User).WithMany(p => p.UserSettings)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_sett__user___382F5661");
        });
        ...
        modelBuilder.Entity<UserSkill>(entity =>
        {
            ...
            entity.HasOne(d => d.Skill).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.SkillId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userSkill_skillID_fk");

            entity.HasOne(d => d.User).WithMany(p => p.UserSkills)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("userSkill_userID_fk");
        });
